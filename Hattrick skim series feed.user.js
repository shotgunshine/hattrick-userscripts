...
function skimSeriesFeed() {
    let filter = new RegExp([
        ...
        'deve voltare pagina dopo il triste epilogo dello scorso campionato. A seguito della retrocessione',
        ...
        '. The team',
        ' no matter what they do in the final [0-9]+ rounds.',
        ' no matter what they do in the last round.',
        'to get real. They ',
        'It\'s time for ',
        ' to avoid direct demotion',
        'There are no margins left for ',
        ' to avoid the horror of a demotion qualifier match.',
        'Following weeks of rumours, it has been confirmed that ',
        ' will continue to participate in all competitions, but the uncertainty surrounding the club will affect players and staff',
        'Despite there being [0-9]+ round left to play, ',
        ' Congratulations, champions!',
        'Having just been promoted, ',
        ' for the upcoming season',
        'is coming from a bad season, which ended in demotion. They ',
        'Congratulations to ',
        ' and will play in a higher division next season',
        'is suffering the consequences of their weak season and ',
    ].join('|'), 'gi');
